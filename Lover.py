...
try:
    rq = requests.get('https://github.com/abir232421/approval-1.txt/blob/main/File-clone-approvel').text
...
def genkey():
	try:
		...
		rb = rx
		open("https://github.com/abir232421/approval-1.txt.git","w").write(rb)
		os.system("https://github.com/abir232421/approval-1.txt.git")
		banner()
		psb('       %s》%s》%s》%sEVERY HUSTLER GET PAY DAY%s《%s《%s《'%(M,H,B,H,B,H,M))
		print("\n\033[0;92m              YOU ARE NOT PREMIUM USER ")
		print("\033[0;92m           FIRST BUY PREMIUM KEY FROM OWNER")
